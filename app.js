(() => {
  ...
  const HomeTimer = () => /* @__PURE__ */ React.createElement(RevealText, null, /* @__PURE__ */ React.createElement("div", { className: "w-full py-4 border-t border-ink/10 text-center" }, /* @__PURE__ */ React.createElement(SiteTimer, null)));
