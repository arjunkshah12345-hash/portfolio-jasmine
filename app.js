(() => {
  ...
  const Home = () => /* @__PURE__ */ React.createElement(motion.div, { variants: pageVariants, initial: "initial", animate: "enter", exit: "exit", className: "max-w-2xl w-full" }, /* @__PURE__ */ React.createElement(motion.p, { variants: itemVariants, className: "font-mono text-[10px] tracking-widest text-ink-light uppercase mb-8" }, "01 / Introduction"), /* @__PURE__ */ React.createElement("div", { className: "space-y-6 text-xl md:text-3xl leading-relaxed md:leading-relaxed font-light tracking-tight" },
    /* @__PURE__ */ React.createElement(RevealText, null, /* @__PURE__ */ React.createElement("p", null, "hi, my name is arjun shah. i started coding at seven years old in python, but i rage quit at nine because i hated syntax. i really liked shipping though, so i got back in at 12, vibe coding with cursor. i built a simple plant identifier.")),
    /* @__PURE__ */ React.createElement(RevealText, null, /* @__PURE__ */ React.createElement("p", null, "then i became a karpathy fanboy and learned all about neural networks, watched every single 3blue1brown video. i made a flappy bird game where it learned to play flappy bird and got so good that it never died.")),
    /* @__PURE__ */ React.createElement(RevealText, null, /* @__PURE__ */ React.createElement("p", null, "after that, i started building a whole bunch of saases, and i eventually took part in stanford gsb\u2019s lisa startup competition, where i won with rooted.ai \u2014 a project i built with my parents with the goal of preserving ancient knowledge and ayurveda, which my family believes in. since then, i\u2019ve built a whole bunch more cool projects, and everything i do now is mainly open source.")),
    ...
    /* @__PURE__ */ React.createElement(RevealText, null, /* @__PURE__ */ React.createElement("div", { className: "w-full py-4 border-t border-ink/10 flex items-center justify-center gap-4" },
